...
void RF24L01_Init( NRF24L01_rtx_t *NRF24L01_rtx )
{
    ...
    NRF24L01_Write_Reg(NRF24L01_rtx, EN_AA, 0);          // 失能通道0自动应答
    NRF24L01_Write_Reg(NRF24L01_rtx, EN_RXADDR, 0x01);       //失能通道0接收   // NRF24L01_Write_Reg(NRF24L01_rtx, SETUP_RETR, 0x00);       // 失能自动重发
    ...
    NRF24L01_Write_Reg(NRF24L01_rtx, RF_CH, 60 );             			//初始化通道
